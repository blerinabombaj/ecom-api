pipeline {
    ...
    steps {
        sh '''
            ...
            docker build -t digdigdigdig/ecom-api:${BUILD_NUMBER} .
            docker tag digdigdigdig/ecom-api:${BUILD_NUMBER} digdigdigdig/ecom-api:latest
        '''
    }
}
        stage('Push Docker') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerhub', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                    sh '''
                        ...
                        docker push digdigdigdig/ecom-api:${BUILD_NUMBER}
                        docker push digdigdigdig/ecom-api:latest
                    '''
                }
            }
        }
